"""
Django settings for santosh_jira_test_404 project.
...
ROOT_URLCONF = 'santosh_jira_test_404.urls'
...
WSGI_APPLICATION = 'santosh_jira_test_404.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "santosh_jira_test_404 API",
    "DESCRIPTION": "API documentation for santosh_jira_test_404 App",
    "VERSION": "v1",
}
